...
{
	$messageTextValue = \CBPCrmSendCustomEmailActivity::decodeMessageText($messageTextValue);
}
...
<tr>
	<td align="right" width="40%"><?=htmlspecialcharsbx($customEmail['Name'])?>:</td>
	<td width="60%">
		<?=CBPDocument::ShowParameterField("string", $customEmail['FieldName'], $dialog->getCurrentValue($customEmail['FieldName']), Array('size'=> 50))?>
		<br><small style="color:gray;">Принимает строку или массив. При передаче массива будет использован первый адрес.</small>
	</td>
</tr>
<!-- Тема письма -->
<tr>
